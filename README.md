# Digital Native Calc (Sidephone Edition)

A distraction-free, 480x640 responsive scientific calculator Progressive Web App (PWA) designed specifically for the Sidephone and other minimalist feature phones.
...
## 📱 Why This Exists
Standard Android calculator applications are often unreadable or cut off when sideloaded onto 2.8-inch, 3:4 aspect ratio displays like the Sidephone. 
